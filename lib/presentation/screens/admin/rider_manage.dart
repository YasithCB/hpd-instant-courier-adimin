...
class RiderManageScreen extends StatefulWidget {
  const RiderManageScreen({Key? key}) : super(key: key);

  @override
  State<RiderManageScreen> createState() => _RiderManageScreenState();
}

class _RiderManageScreenState extends State<RiderManageScreen> {
  ...
  Future<void> _saveNewRider() async {
    ...
    //           ? showSnackBar('Rider Saved Succesffull!')
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text('Save New Rider'),
          ),
        ],
      ),
    );
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                //       return const Text('Error fetching rider details');
